package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.BinaryIn.java
 *  Execution:    java seidgewick.BinaryIn input output
 *  
 *  This library is for reading binary data from an input stream.
 *
 *  % java seidgewick.BinaryIn http://introcs.cs.princeton.edu/cover.jpg output.jpg
 *
 *************************************************************************/
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to <tt>seidgewick.BinaryIn</tt> with calls
 *  to <tt>seidgewick.In</tt>; otherwise unexpected behavior will result.
 *
