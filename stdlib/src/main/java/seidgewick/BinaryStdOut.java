package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.BinaryStdOut.java
 *  Execution:    java seidgewick.BinaryStdOut
 *
 ...
 *  <p>
 *  The client should not intermixing calls to <tt>seidgewick.BinaryStdOut</tt> with calls
 *  to <tt>seidgewick.StdOut</tt> or <tt>System.out</tt>; otherwise unexpected behavior
 *  will result.
 *
