package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.In.java
 *  Execution:    java seidgewick.In   (basic test --- see source for required files)
 *
...
public final class In {
   ...
   /**
     ...
     * <tt>new seidgewick.In(filename)</tt>.{@link #readAllInts()}
     */
   ...
   /**
     ...
     * @deprecated Clearer to use 
     * <tt>new seidgewick.In(filename)</tt>.{@link #readAllDoubles()}
     */
   ...
   /**
     ...
     * @deprecated Clearer to use 
     * <tt>new seidgewick.In(filename)</tt>.{@link #readAllStrings()}
     */
