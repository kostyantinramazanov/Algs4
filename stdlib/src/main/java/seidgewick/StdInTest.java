package seidgewick; /**
 * Test client for seidgewick.StdIn and seidgewick.In.
 **/
...
public class StdInTest {
    ...
    /**
     * seidgewick.In the two methods below, each Object[] of "steps" is a length-2
    ...
    public static void test(String input, Object[][] steps, boolean useStdIn) {
        ...
        if (useStdIn) {
            ...
            try { //call seidgewick.StdIn.resync();
    ...
    public static void main(String[] args) {
        ...
        if (testStdIn) 
            ...
            StdOut.println("Note: seidgewick.StdIn.resync is private, only seidgewick.In will be tested.");
