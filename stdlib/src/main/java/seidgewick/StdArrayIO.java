package seidgewick;
/*************************************************************************
 *  Compilation:  javac seidgewick.StdArrayIO.java
 *  Execution:    java seidgewick.StdArrayIO < input.txt
 *
 ...
 *    1 1 1
 *
 *  % cat tinyDouble1D.txt tinyDouble2D.txt tinyBoolean2D.txt | java seidgewick.StdArrayIO
 *  4
