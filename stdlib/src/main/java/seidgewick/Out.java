package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.Out.java
 *  Execution:    java seidgewick.Out
 *
...
public class Out {
    ...
    // assume language = English, country = US for consistency with seidgewick.In
    private static final Locale US_LOCALE = new Locale("en", "US");

    private PrintWriter out;

   /**
     * Create an seidgewick.Out object using an OutputStream.
     */
   ...
   /**
     * Create an seidgewick.Out object using standard output.
     */
    public Out() { this(System.out); }

   /**
     * Create an seidgewick.Out object using a Socket.
     */
   ...
   /**
     * Create an seidgewick.Out object using a file specified by the given name.
     */
    public Out(String s) {
        try {
