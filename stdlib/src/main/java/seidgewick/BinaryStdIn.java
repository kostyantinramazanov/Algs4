package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.BinaryStdIn.java
 *  Execution:    java seidgewick.BinaryStdIn < input > output
 *  
 *  Supports reading binary data from standard input.
 *
 *  % java seidgewick.BinaryStdIn < input.jpg > output.jpg
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to <tt>seidgewick.BinaryStdIn</tt> with calls
 *  to <tt>seidgewick.StdIn</tt> or <tt>System.in</tt>;
   ...
   /**
    ...
    public static void close() {
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("Could not close seidgewick.BinaryStdIn");
        }
    }
