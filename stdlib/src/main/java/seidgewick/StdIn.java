package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.StdIn.java
 *  Execution:    java seidgewick.StdIn   (interactive test of basic functionality)
 *
 ...
 *  <p>
 *  See the technical information in the documentation of the {@link seidgewick.In}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from seidgewick.In to seidgewick.StdIn */
    ...
    /*** end: section (1 of 2) of code duplicated from seidgewick.In to seidgewick.StdIn */

    /*** begin: section (2 of 2) of code duplicated from seidgewick.In to seidgewick.StdIn,
   ...
   /**
    ...
    public static char readChar() {
        ...
        assert (ch.length() == 1) : "Internal (Std)seidgewick.In.readChar() error!"
   ...
   /**
    ...
    /*** end: section (2 of 2) of code duplicated from seidgewick.In to seidgewick.StdIn */
    
    
    /**
     * If seidgewick.StdIn changes, use this to reinitialize the scanner.
     */
    ...
    // do this once when seidgewick.StdIn is initialized
    static {
        resync();
    }
