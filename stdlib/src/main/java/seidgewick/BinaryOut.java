package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.BinaryOut.java
 *  Execution:    java seidgewick.BinaryOut
 *
 ...
 *  <p>
 *  The client should not intermixing calls to <tt>seidgewick.BinaryOut</tt> with calls
 *  to <tt>seidgewick.Out</tt>; otherwise unexpected behavior will result.
 *
