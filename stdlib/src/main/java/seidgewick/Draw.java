package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.Draw.java
 *  Execution:    java seidgewick.Draw
 *
...
/**
 *  <i>seidgewick.Draw</i>. This class provides a basic capability for
...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    // name of window
    private String name = "seidgewick.Draw";
    ...
    *************************************************************************/
    ...
    /**
     * seidgewick.Draw a line from (x0, y0) to (x1, y1).
    ...
    /**
     * seidgewick.Draw one pixel at (x, y).
    ...
    /**
     * seidgewick.Draw a point at (x, y).
    ...
    /**
     * seidgewick.Draw a circle of radius r, centered on (x, y).
    ...
    /**
     * seidgewick.Draw filled circle of radius r, centered on (x, y).
     * @param x the x-coordinate of the center of the circle
     * @param y the y-coordinate of the center of the circle
     * @param r the radius of the circle
     * @throws RuntimeException if the radius of the circle is negative
    ...
    /**
     * seidgewick.Draw an ellipse with given semimajor and semiminor axes, centered on (x, y).
    ...
    /**
     * seidgewick.Draw an arc of radius r, centered on (x, y), from angle1 to angle2 (in degrees).
     * @param x the x-coordinate of the center of the circle
     * @param y the y-coordinate of the center of the circle
     * @param r the radius of the circle
    ...
    /**
     * seidgewick.Draw a square of side length 2r, centered on (x, y).
    ...
    /**
     * seidgewick.Draw a filled square of side length 2r, centered on (x, y).
     * @param x the x-coordinate of the center of the square
     * @param y the y-coordinate of the center of the square
     * @param r radius is half the length of any side of the square
     * @throws RuntimeException if r is negative
    ...
    /**
     * seidgewick.Draw a rectangle of given half width and half height, centered on (x, y).
    ...
    /**
     * seidgewick.Draw a filled rectangle of given half width and half height, centered on (x, y).
     * @param x the x-coordinate of the center of the rectangle
     * @param y the y-coordinate of the center of the rectangle
     * @param halfWidth is half the width of the rectangle
     * @param halfHeight is half the height of the rectangle
    ...
    /**
     * seidgewick.Draw a polygon with the given (x[i], y[i]) coordinates.
    ...
    /**
     * seidgewick.Draw a filled polygon with the given (x[i], y[i]) coordinates.
     * @param x an array of all the x-coordindates of the polygon
     * @param y an array of all the y-coordindates of the polygon
     */
    ...
    *************************************************************************/
    ...
    /**
     * seidgewick.Draw picture (gif, jpg, or png) centered on (x, y).
