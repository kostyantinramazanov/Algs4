...
/*************************************************************************
 *  Compilation:  javac seidgewick.GREP.java
 *  Execution:    java seidgewick.GREP regexp < input.txt
 *  Dependencies: seidgewick.NFA.java
 ...
 *  BABBAAA
 *
 *  %  java seidgewick.GREP "(A*B|AC)D" < tinyL.txt
 *  ABD
 *  ABCCBD
 *
 *************************************************************************/
