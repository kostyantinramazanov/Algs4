package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.IndexMaxPQ.java
 *  Execution:    java seidgewick.IndexMaxPQ
 *
...
/**
 *  The <tt>seidgewick.IndexMaxPQ</tt> class represents an indexed priority queue of generic keys.
...
public class IndexMaxPQ<Key extends Comparable<Key>> implements Iterable<Integer> {
    ...
    **********************************************************************/
    ...
    /**
     * Unit tests the <tt>seidgewick.IndexMaxPQ</tt> data type.
     */
