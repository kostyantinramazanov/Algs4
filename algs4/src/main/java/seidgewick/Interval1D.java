package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.Interval1D.java
 *  Execution:    java seidgewick.Interval1D
 *  
...
/**
 *  The <tt>seidgewick.Interval1D</tt> class represents a one-dimensional closed interval.
 *  Intervals are immutable: their values cannot be changed after they are created.
 *  The class <code>seidgewick.Interval1D</code> includes methods for checking whether
...
public class Interval1D {
    ...
    /**
     * Unit tests the <tt>seidgewick.Interval1D</tt> data type.
     */
