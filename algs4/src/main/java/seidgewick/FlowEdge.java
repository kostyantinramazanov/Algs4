package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.FlowEdge.java
 *  Execution:    java seidgewick.FlowEdge
 *
...
/**
 *  The <tt>seidgewick.FlowEdge</tt> class represents a capacitated edge with a
...
public class FlowEdge {
    ...
    public FlowEdge(int v, int w, double capacity) {
        ...
        if (!(capacity >= 0.0)) throw new IllegalArgumentException("seidgewick.Edge capacity must be nonnegaitve");
        this.v         = v;
        this.w         = w;  
   ...
   /**
     * Unit tests the <tt>seidgewick.FlowEdge</tt> data type.
     */
