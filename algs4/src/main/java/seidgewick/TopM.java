package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.TopM.java
 *  Execution:    java seidgewick.TopM M < input.txt
 *  Dependencies: seidgewick.MinPQ.java seidgewick.Transaction.java StdIn.java StdOut.java
 ...
 *  each line contains a String and a long value, this seidgewick.MinPQ client
 *  prints the M lines whose numbers are the highest.
 * 
 *  % java seidgewick.TopM 5 < tinyBatch.txt
...
/**
 *  The <tt>seidgewick.TopM</tt> class provides a client that reads a sequence of
