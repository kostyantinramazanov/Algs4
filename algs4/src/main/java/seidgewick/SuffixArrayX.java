package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.SuffixArrayX.java
 *  Execution:    java seidgewick.SuffixArrayX < input.txt
 *  
 *  A data type that computes the suffix array of a string using 3-way
 *  radix quicksort.
 *
 *  % java seidgewick.SuffixArrayX < abra.txt
...
/**
 *  The <tt>seidgewick.SuffixArrayX</tt> class represents a suffix array of a string of
 *  length <em>N</em>.
