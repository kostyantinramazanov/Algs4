...
/*************************************************************************
 *  Compilation:  javac seidgewick.KWIK.java
 *  Execution:    java seidgewick.KWIK file.txt
 *  Dependencies: StdIn.java StdOut.java In.java seidgewick.SuffixArray.java
 *  Data files:   http://algs4.cs.princeton.edu/63suffix/tale.txt
 *
 *  %  java seidgewick.KWIK tale.txt 15
 *  majesty
