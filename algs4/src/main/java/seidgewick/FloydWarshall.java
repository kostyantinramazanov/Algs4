package seidgewick; /*************************************************************************
 * Compilation:  javac seidgewick.FloydWarshall.java
 * Execution:  java seidgewick.FloydWarshall V E
 * Dependencies: seidgewick.AdjMatrixEdgeWeightedDigraph.java
 *
 * Floyd-Warshall all-pairs shortest path algorithm.
 *
 * % java seidgewick.FloydWarshall 100 500
 *
...
/**
 * The <tt>seidgewick.FloydWarshall</tt> class represents a data type for solving the
 ...
 */ public class FloydWarshall {
    ...
    /**
     * Unit tests the <tt>seidgewick.FloydWarshall</tt> data type.
     */
