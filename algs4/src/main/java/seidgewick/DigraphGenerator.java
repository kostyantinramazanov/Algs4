package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.DigraphGenerator.java
 *  Execution:    java seidgewick.DigraphGenerator V E
 *  Dependencies: seidgewick.Digraph.java
 *
 *  A digraph generator.
 *  
 *************************************************************************/
...
/**
 *  The <tt>seidgewick.DigraphGenerator</tt> class provides static methods for creating
...
public class DigraphGenerator {
   ...
   /**
    ...
    /**
     * Unit tests the <tt>seidgewick.DigraphGenerator</tt> library.
     */
