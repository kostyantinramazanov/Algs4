 ...
 *  Dependencies: seidgewick.Digraph.java seidgewick.DepthFirstOrder.java seidgewick.DirectedCycle.java
 *                seidgewick.EdgeWeightedDigraph.java seidgewick.EdgeWeightedDirectedCycle.java
 *                seidgewick.SymbolDigraph.java
 *  Data files:   http://algs4.cs.princeton.edu/42directed/jobs.txt
 *
 *  Compute topological ordering of a DAG or edge-weighted DAG.
 *  Runs in O(E + V) time.
 *
 *  % java seidgewick.Topological jobs.txt "/"
 *  Calculus
 *  Linear Algebra
 *  Introduction to CS
 *  Programming Systems
...
/**
 *  The <tt>seidgewick.Topological</tt> class represents a data type for
...
public class Topological {
    ...
    /**
     * Unit tests the <tt>seidgewick.Topological</tt> data type.
     */
