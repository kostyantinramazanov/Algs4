package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.Edge.java
 *  Execution:    java seidgewick.Edge
 *
...
/**
 *  The <tt>seidgewick.Edge</tt> class represents a weighted edge in an
...
public class Edge implements Comparable<Edge> { 
    ...
    /**
     * Unit tests the <tt>seidgewick.Edge</tt> data type.
     */
