package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.EdgeWeightedGraph.java
 *  Execution:    java seidgewick.EdgeWeightedGraph filename.txt
 *  Dependencies: seidgewick.Bag.java seidgewick.Edge.java In.java StdOut.java
 *  Data files:   http://algs4.cs.princeton.edu/43mst/tinyEWG.txt
 *
 *  An edge-weighted undirected graph, implemented using adjacency lists.
 *  Parallel edges and self-loops are permitted.
 *
 *  % java seidgewick.EdgeWeightedGraph tinyEWG.txt
 *  8 16
...
/**
 *  The <tt>seidgewick.EdgeWeightedGraph</tt> class represents an edge-weighted
...
public class EdgeWeightedGraph {
     ...
     * <tt>for (seidgewick.Edge e : G.edges())</tt>.
    ...
    /**
     * Unit tests the <tt>seidgewick.EdgeWeightedGraph</tt> data type.
     */
