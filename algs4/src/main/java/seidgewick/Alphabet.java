...
/*************************************************************************
 *  Compilation:  javac seidgewick.Alphabet.java
 *  Execution:    java  seidgewick.Alphabet
 *  
...
public class Alphabet {
    ...
    // Create a new seidgewick.Alphabet from sequence of characters in string.
    ...
    // Create a new seidgewick.Alphabet of Unicode chars 0 to R-1
    ...
    // Create a new seidgewick.Alphabet of Unicode chars 0 to 255 (extended ASCII)
    public Alphabet() {
        this(256);
    }
    ...
    public char toChar(int index) {
        if (index < 0 || index >= R) {
            throw new IndexOutOfBoundsException("seidgewick.Alphabet index out of bounds");
        }
