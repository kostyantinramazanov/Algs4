package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.GabowSCC.java
 *  Execution:    java seidgewick.GabowSCC V E
 ...
 *  Runs in O(E + V) time.
 *
 *  % java seidgewick.GabowSCC tinyDG.txt
 *  5 components
 *  1 
 *  0 2 3 4 5 
 *  9 10 11 12 
 ...
 *************************************************************************/
/**
 *  The <tt>seidgewick.GabowSCC</tt> class represents a data type for
...
public class GabowSCC {
    ...
    /**
     * Unit tests the <tt>seidgewick.GabowSCC</tt> data type.
     */
