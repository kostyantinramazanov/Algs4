package seidgewick; /*************************************************************************
 *  Compilation:  javac -cp .:jama.jar seidgewick.PolynomialRegression.java
 *  Execution:    java  -cp .:jama.jar seidgewick.PolynomialRegression
 *  Dependencies: jama.jar StdOut.java
 * 
 *  % java -cp .:jama.jar seidgewick.PolynomialRegression
...
/**
 *  The <tt>seidgewick.PolynomialRegression</tt> class performs a polynomial regression
