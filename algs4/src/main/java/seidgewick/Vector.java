package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.Vector.java
 *  Execution:    java seidgewick.Vector
 *
 *  Implementation of a vector of real numbers.
 *
 *  This class is implemented to be immutable: once the client program
 *  initialize a seidgewick.Vector, it cannot change any of its fields
 *  (N or data[i]) either directly or indirectly. Immutability is a
 *  very desirable feature of a data type.
 *
 *  % java seidgewick.Vector
 *     x     = [ 1.0 2.0 3.0 4.0 ]
 *     y     = [ 5.0 2.0 4.0 1.0 ]
 *     z     = [ 6.0 4.0 7.0 5.0 ]
 ...
 * 
 *
 *  Note that seidgewick.Vector is also the name of an unrelated Java library class.
 *
 *************************************************************************/

/**
 *  The <tt>seidgewick.Vector</tt> class represents a <em>d</em>-dimensional mathematical vector.
...
public class Vector { 
     ...
     * arugments such as seidgewick.Vector x = new seidgewick.Vector(1.0, 2.0, 3.0, 4.0).
