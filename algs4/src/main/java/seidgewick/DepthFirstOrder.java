package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.DepthFirstOrder.java
 *  Execution:    java seidgewick.DepthFirstOrder filename.txt
 *  Dependencies: seidgewick.Digraph.java seidgewick.Queue.java seidgewick.Stack.java StdOut.java
 *                seidgewick.EdgeWeightedDigraph.java seidgewick.DirectedEdge.java
 ...
 *  Runs in O(E + V) time.
 *
 *  % java seidgewick.DepthFirstOrder tinyDAG.txt
 *     v  pre post
 *  --------------
 *     0    0    8
 *     1    3    2
...
/**
 *  The <tt>seidgewick.DepthFirstOrder</tt> class represents a data type for
...
public class DepthFirstOrder {
    ...
    /**
     * Unit tests the <tt>seidgewick.DepthFirstOrder</tt> data type.
     */
