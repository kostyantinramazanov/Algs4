package seidgewick; /****************************************************************************
 *  Compilation:  javac seidgewick.QuickUnionUF.java
 *  Execution:  java seidgewick.QuickUnionUF < input.txt
 *  Dependencies: StdIn.java StdOut.java
 *
 *  seidgewick.Quick-union algorithm.
 *
 ****************************************************************************/

/**
 *  The <tt>seidgewick.QuickUnionUF</tt> class represents a union-find data structure.
