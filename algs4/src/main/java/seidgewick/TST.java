...
/*************************************************************************
 *  Compilation:  javac seidgewick.TST.java
 *  Execution:    java seidgewick.TST < words.txt
 ...
 *
 *
 *  % java seidgewick.TST < shellsST.txt
 *  by 4
 *  sea 6
 *  sells 1
 *  she 0
...
public class TST<Value> {
    private int N;       // size
    private Node root;   // root of seidgewick.TST
   ...
   /**************************************************************
    * Find and return longest prefix of s in seidgewick.TST
    **************************************************************/
