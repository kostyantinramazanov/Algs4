package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.BellmanFordSP.java
 *  Execution:    java seidgewick.BellmanFordSP filename.txt s
 *  Dependencies: seidgewick.EdgeWeightedDigraph.java seidgewick.DirectedEdge.java seidgewick.Queue.java
 *                seidgewick.EdgeWeightedDirectedCycle.java
 ...
 *  reachable from s.
 *
 *  % java seidgewick.BellmanFordSP tinyEWDn.txt 0
 *  0 to 0 ( 0.00)  
 ...
 *
 *  % java seidgewick.BellmanFordSP tinyEWDnc.txt 0
 *  4->5  0.35
 *  5->4 -0.66
 *
 *
...
/**
 *  The <tt>seidgewick.BellmanFordSP</tt> class represents a data type for solving the
...
public class BellmanFordSP {
    ...
    /**
     * Unit tests the <tt>seidgewick.BellmanFordSP</tt> data type.
     */
