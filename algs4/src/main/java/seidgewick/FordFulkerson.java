package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.FordFulkerson.java
 *  Execution:    java seidgewick.FordFulkerson V E
 *  Dependencies: seidgewick.FlowNetwork.java seidgewick.FlowEdge.java seidgewick.Queue.java
 *
...
/**
 *  The <tt>seidgewick.FordFulkerson</tt> class represents a data type for computing a
...
public class FordFulkerson {
        ...
        for (int v = 0; v < G.V(); v++) {
            for (FlowEdge e : G.adj(v)) {
                if (e.flow() < -EPSILON || e.flow() > e.capacity() + EPSILON) {
                    System.err.println("seidgewick.Edge does not satisfy capacity constraints: " + e);
                    return false;
                }
            }
        }
    ...
    /**
     * Unit tests the <tt>seidgewick.FordFulkerson</tt> data type.
     */
