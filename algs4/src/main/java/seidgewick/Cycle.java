package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.Cycle.java
 *  Dependencies: seidgewick.Graph.java seidgewick.Stack.java
 *
 *  Identifies a cycle.
 *  Runs in O(E + V) time.
 *
 *  % java seidgewick.Cycle tinyG.txt
 *  3 4 5 3 
 * 
 *  % java seidgewick.Cycle mediumG.txt
 *  15 0 225 15 
 * 
 *  % java seidgewick.Cycle largeG.txt
 *  996673 762 840164 4619 785187 194717 996673 
 *
 *************************************************************************/

/**
 *  The <tt>seidgewick.Cycle</tt> class represents a data type for
...
public class Cycle {
   ...
   public Iterable<Integer> cycle() {
    ...
    /**
     * Unit tests the <tt>seidgewick.Cycle</tt> data type.
     */
    public static void main(String[] args) {
        ...
        if (finder.hasCycle()) {
            ...
            StdOut.println("seidgewick.Graph is acyclic");
        }
    }
