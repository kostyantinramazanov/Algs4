package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.MinPQ.java
 *  Execution:    java seidgewick.MinPQ < input.txt
 *  
 *  Generic min priority queue implementation with a binary heap.
 *  Can be used with a comparator instead of the natural order.
 *
 *  % java seidgewick.MinPQ < tinyPQ.txt
 *  E A E (6 left on pq)
 *
...
/**
 *  The <tt>seidgewick.MinPQ</tt> class represents a priority queue of generic keys.
...
public class MinPQ<Key> implements Iterable<Key> {
    ...
    **********************************************************************/
    ...
    /**
     * Unit tests the <tt>seidgewick.MinPQ</tt> data type.
     */
