package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.ThreeSumFast.java
 *  Execution:    java seidgewick.ThreeSumFast input.txt
 *  Dependencies: StdOut.java In.java seidgewick.Stopwatch.java
 ...
 *
 *
 *  % java seidgewick.ThreeSumFast 1Kints.txt
 *  70
 *  
 *  % java seidgewick.ThreeSumFast 2Kints.txt
 *  528
 *                
 *  % java seidgewick.ThreeSumFast 4Kints.txt
 *  4039
 * 
 *  % java seidgewick.ThreeSumFast 8Kints.txt
 *  32074
 *
 *  % java seidgewick.ThreeSumFast 16Kints.txt
 *  255181
 *
 *  % java seidgewick.ThreeSumFast 32Kints.txt
 *  2052358
 *
 *************************************************************************/
...
/**
 *  The <tt>seidgewick.ThreeSumFast</tt> class provides static methods for counting
