package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.DegreesOfSeparation.java
 *  Execution:    java seidgewick.DegreesOfSeparation filename delimiter source
 *  Dependencies: seidgewick.SymbolGraph.java seidgewick.Graph.java seidgewick.BreadthFirstPaths.java StdOut.java
 *  Data files:   http://algs4.cs.princeton.edu/41undirected/routes.txt
 *                http://algs4.cs.princeton.edu/41undirected/movies.txt
 *  
 *  
 *  %  java seidgewick.DegreesOfSeparation routes.txt " " "JFK"
 *  LAS
 *     JFK
 *     ORD
 *     DEN
 ...
 *     Not in database.
 *
 *  % java seidgewick.DegreesOfSeparation movies.txt "/" "Bacon, Kevin"
 *  Kidman, Nicole
 *     Bacon, Kevin
 *     Woodsman, The (2004)
 *     Grier, David Alan
 ...
 *     Grant, Cary
 *
 *  % java seidgewick.DegreesOfSeparation movies.txt "/" "Animal House (1978)"
 *  Titanic (1997)
 *     Animal House (1978)
 *     Allen, Karen (I)
...
/**
 *  The <tt>seidgewick.DegreesOfSeparation</tt> class provides a client for finding
