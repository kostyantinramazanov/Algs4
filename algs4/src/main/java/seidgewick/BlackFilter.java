...
/*************************************************************************
 *  Compilation:  javac seidgewick.BlackFilter.java
 *  Execution:    java seidgewick.BlackFilter blacklist.txt < input.txt
 *  Dependencies: seidgewick.SET In.java StdIn.java StdOut.java
 ...
 *  was it the of 
 * 
 *  % java seidgewick.BlackFilter list.txt < tinyTale.txt
