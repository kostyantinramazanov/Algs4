package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.DirectedCycle.java
 *  Execution:    java seidgewick.DirectedCycle < input.txt
 *  Dependencies: seidgewick.Digraph.java seidgewick.Stack.java StdOut.java In.java
 ...
 *  Runs in O(E + V) time.
 *
 *  % java seidgewick.DirectedCycle tinyDG.txt
 *  seidgewick.Cycle: 3 5 4 3
 *
 *  %  java seidgewick.DirectedCycle tinyDAG.txt
 *  No cycle
 *
 *************************************************************************/

/**
 *  The <tt>seidgewick.DirectedCycle</tt> class represents a data type for
...
public class DirectedCycle {
    ...
    /**
     * Unit tests the <tt>seidgewick.DirectedCycle</tt> data type.
     */
