package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.ThreeSum.java
 *  Execution:    java seidgewick.ThreeSum input.txt
 *  Dependencies: In.java StdOut.java seidgewick.Stopwatch.java
 ...
 *
 *  % java seidgewick.ThreeSum 1Kints.txt
 *  70
 *
 *  % java seidgewick.ThreeSum 2Kints.txt
 *  528
 *
 *  % java seidgewick.ThreeSum 4Kints.txt
 *  4039
 *
 *************************************************************************/

/**
 *  The <tt>seidgewick.ThreeSum</tt> class provides static methods for counting
