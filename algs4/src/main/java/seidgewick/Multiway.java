package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.Multiway.java
 *  Execution:    java seidgewick.Multiway input1.txt input2.txt input3.txt ...
 *  Dependencies: seidgewick.IndexMinPQ.java In.java StdOut.java
 * 
 ...
 *  A B E F J N
 *
 *  % java seidgewick.Multiway m1.txt m2.txt m3.txt
 *  A A B B B C D E F F G H I I J N P Q Q Z 
 *
 *************************************************************************/

/**
 *  The <tt>seidgewick.Multiway</tt> class provides a client for reading in several
