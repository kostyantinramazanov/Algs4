package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.Arbitrage.java
 *  Execution:    java seidgewick.Arbitrage < input.txt
 *  Dependencies: seidgewick.EdgeWeightedDigraph.java seidgewick.DirectedEdge.java
 *                seidgewick.BellmanFordSP.java
 *  Data file:    http://algs4.cs.princeton.edu/44sp/rates.txt
 *
 *  seidgewick.Arbitrage detection.
 *
 *  % more rates.txt
 *  5
 ...
 *
 *  % java seidgewick.Arbitrage < rates.txt
...
/**
 *  The <tt>seidgewick.Arbitrage</tt> class provides a client that finds an arbitrage
