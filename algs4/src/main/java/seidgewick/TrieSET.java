package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.TrieSET.java
 *  Execution:    java seidgewick.TrieSET < words.txt
...
/**
 *  The <tt>seidgewick.TrieSET</tt> class represents an ordered set of strings over
