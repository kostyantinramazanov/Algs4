package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.TransitiveClosure.java
 *  Execution:    java seidgewick.TransitiveClosure filename.txt
 *  Dependencies: seidgewick.Digraph.java seidgewick.DepthFirstDirectedPaths.java In.java StdOut.java
 ...
 *  Space: O(V^2).
 *
 *  % java seidgewick.TransitiveClosure tinyDG.txt
...
/**
 *  The <tt>seidgewick.TransitiveClosure</tt> class represents a data type for
...
public class TransitiveClosure {
    ...
    /**
     * Unit tests the <tt>seidgewick.TransitiveClosure</tt> data type.
     */
