package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.AcyclicLP.java
 ...
 *
 *  % java seidgewick.AcyclicLP tinyEWDAG.txt 5
...
/**
 *  The <tt>seidgewick.AcyclicLP</tt> class represents a data type for solving the
...
public class AcyclicLP {
    ...
    /**
     * Unit tests the <tt>seidgewick.AcyclicLP</tt> data type.
     */
