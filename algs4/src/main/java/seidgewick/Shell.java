package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.Shell.java
 *  Execution:    java seidgewick.Shell < input.txt
 ...
 *
 *  % java seidgewick.Shell < tiny.txt
 *  A E E L M O P R S T X                 [ one string per line ]
 *    
 *  % more words3.txt
 *  bed bug dad yes zoo ... all bad yet
 *  
 *  % java seidgewick.Shell < words3.txt
...
/**
 *  The <tt>seidgewick.Shell</tt> class provides static methods for sorting an
 *  array using Shellsort with seidgewick.Knuth's increment sequence (1, 4, 13, 40, ...).
 *  <p>
