package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.Whitelist.java
 *  Execution:    java seidgewick.Whitelist whitelist.txt < data.txt
 ...
 *
 *  seidgewick.Whitelist filter.
 *
 *
 *  % java seidgewick.Whitelist tinyW.txt < tinyT.txt
 *  50
 *  99
 *  13
 *
 *  % java seidgewick.Whitelist largeW.txt < largeT.txt | more
 *  499569
 *  984875
 *  295754
 *  207807
...
/**
 *  The <tt>seidgewick.Whitelist</tt> class provides a client for reading in
