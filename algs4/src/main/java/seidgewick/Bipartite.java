package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.Bipartite.java
 *  Dependencies: seidgewick.Graph.java
 *
...
/**
 *  The <tt>seidgewick.Bipartite</tt> class represents a data type for
...
public class Bipartite {
    ...
    public boolean color(int v) {
        if (!isBipartite)
            throw new UnsupportedOperationException("seidgewick.Graph is not bipartite");
        return color[v];
    }
    ...
    /**
     * Unit tests the <tt>seidgewick.Bipartite</tt> data type.
     */
    public static void main(String[] args) {
        ...
        if (b.isBipartite()) {
            StdOut.println("seidgewick.Graph is bipartite");
            for (int v = 0; v < G.V(); v++) {
                StdOut.println(v + ": " + b.color(v));
            }
        }
        else {
            StdOut.print("seidgewick.Graph has an odd-length cycle: ");
