...
/*************************************************************************
 *  Compilation:  javac seidgewick.LookupCSV.java
 *  Execution:    java seidgewick.LookupCSV file.csv keyField valField
 *  Dependencies: seidgewick.ST.java In.java StdIn.java StdOut.java
 ...
 * 
 *  % java seidgewick.LookupCSV amino.csv 0 3     % java seidgewick.LookupCSV ip.csv 0 1
 *  TTA                                www.google.com 
 *  Leucine                            216.239.41.99 
 *  ABC                               
 *  Not found                          % java seidgewick.LookupCSV ip.csv 1 0
 *  TCT                                216.239.41.99 
 *  Serine                             www.google.com 
 *                                 
 *  % java seidgewick.LookupCSV amino.csv 3 0     % java seidgewick.LookupCSV DJIA.csv 0 1
 *  Glycine                            29-Oct-29 
 *  GGG                                252.38 
 *                                     20-Oct-87 
 *                                     1738.74
