package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.CollisionSystem.java
 *  Execution:    java seidgewick.CollisionSystem N               (N random particles)
 *                java seidgewick.CollisionSystem < input.txt     (from a file)
 *  
