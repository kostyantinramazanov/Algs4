package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.KosarajuSharirSCC.java
 *  Execution:    java seidgewick.KosarajuSharirSCC filename.txt
 *  Dependencies: seidgewick.Digraph.java seidgewick.TransitiveClosure.java StdOut.java In.java
 ...
 *  7 8 
 *
 *  % java seidgewick.KosarajuSharirSCC mediumDG.txt
 *  10 components
 *  21 
 ...
 *  10 
 *
 *  % java -Xss50m seidgewick.KosarajuSharirSCC mediumDG.txt
 *  25 components
...
/**
 *  The <tt>seidgewick.KosarajuSharirSCC</tt> class represents a data type for
...
public class KosarajuSharirSCC {
    ...
    /**
     * Unit tests the <tt>seidgewick.KosarajuSharirSCC</tt> data type.
     */
