package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.Transaction.java
 *  Execution:    java seidgewick.Transaction
 *  
...
/**
 *  The <tt>seidgewick.Transaction</tt> class is an immutable data type to encapsulate a
...
public class Transaction implements Comparable<Transaction> {
    ...
    public static void main(String[] args) {
        ...
        a[2] = new Transaction("seidgewick.Knuth    6/14/1999  288.34");
