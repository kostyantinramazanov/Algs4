package seidgewick; /****************************************************************************
 *  Compilation:  javac seidgewick.WeightedQuickUnionUF.java
 *  Execution:  java seidgewick.WeightedQuickUnionUF < input.txt
...
/**
 *  The <tt>seidgewick.WeightedQuickUnionUF</tt> class represents a union-find data structure.
