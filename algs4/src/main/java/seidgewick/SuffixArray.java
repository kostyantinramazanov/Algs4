package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.SuffixArray.java
 *  Execution:  java seidgewick.SuffixArray < input.txt
 *
 *  A data type that computes the suffix array of a string.
 *
 *   % java seidgewick.SuffixArray < abra.txt
 ...
 *   11   2   2  11  "RACADABRA!"
 *
 *  See seidgewick.SuffixArrayX.java for an optimized version that uses 3-way
...
/**
 *  The <tt>seidgewick.SuffixArray</tt> class represents a suffix array of a string of
 *  length <em>N</em>.
...
public class SuffixArray {
    ...
    /**
     * Unit tests the <tt>seidgewick.SuffixArray</tt> data type.
     */
