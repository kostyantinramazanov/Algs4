package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.SequentialSearchST.java
 *  Execution:    java seidgewick.SequentialSearchST
 ...
 *
 *  % java seidgewick.SequentialSearchST < tiny.txt
 *  L 11
 *  P 10
 *  M 9
 *  X 7
...
/**
 *  The <tt>seidgewick.SequentialSearchST</tt> class represents an (unordered)
...
public class SequentialSearchST<Key, Value> {
    ...
    /**
     * Unit tests the <tt>seidgewick.SequentialSearchST</tt> data type.
     */
