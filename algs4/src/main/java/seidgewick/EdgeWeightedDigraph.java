package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.EdgeWeightedDigraph.java
 *  Execution:    java seidgewick.EdgeWeightedDigraph V E
 *  Dependencies: seidgewick.Bag.java seidgewick.DirectedEdge.java
 *
...
/**
 *  The <tt>seidgewick.EdgeWeightedDigraph</tt> class represents a edge-weighted
 ...
 *  is a vertex-indexed array of @link{seidgewick.Bag} objects.
...
public class EdgeWeightedDigraph {
    ...
    public EdgeWeightedDigraph(int V) {
        if (V < 0) throw new IllegalArgumentException("Number of vertices in a seidgewick.Digraph must be nonnegative");
        this.V = V;
        this.E = 0;
    ...
    public EdgeWeightedDigraph(int V, int E) {
        this(V);
        if (E < 0) throw new IllegalArgumentException("Number of edges in a seidgewick.Digraph must be nonnegative");
        for (int i = 0; i < E; i++) {
     ...
     * <tt>for (seidgewick.DirectedEdge e : G.edges())</tt>.
    ...
    /**
     * Unit tests the <tt>seidgewick.EdgeWeightedDigraph</tt> data type.
     */
