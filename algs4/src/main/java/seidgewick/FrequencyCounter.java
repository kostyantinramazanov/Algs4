package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.FrequencyCounter.java
 *  Execution:    java seidgewick.FrequencyCounter L < input.txt
 *  Dependencies: seidgewick.ST.java StdIn.java StdOut.java
 ...
 *  a given threshold.
 *
 *  % java seidgewick.FrequencyCounter 1 < tinyTale.txt
 *  it 10
 *
 *  % java seidgewick.FrequencyCounter 8 < tale.txt
 *  business 122
 *
 *  % java seidgewick.FrequencyCounter 10 < leipzig1M.txt
 *  government 24763
 *
 *
 *************************************************************************/
...
/**
 *  The <tt>seidgewick.FrequencyCounter</tt> class provides a client for
