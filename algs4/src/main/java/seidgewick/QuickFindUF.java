package seidgewick; /****************************************************************************
 *  Compilation:  javac seidgewick.QuickFindUF.java
 *  Execution:  java seidgewick.QuickFindUF < input.txt
 *  Dependencies: StdIn.java StdOut.java
 *
 *  seidgewick.Quick-find algorithm.
 *
 ****************************************************************************/

/**
 *  The <tt>seidgewick.QuickFindUF</tt> class represents a union-find data structure.
