package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.FlowNetwork.java
 *  Execution:    java seidgewick.FlowNetwork V E
 *  Dependencies: seidgewick.Bag.java seidgewick.FlowEdge.java
 *
...
/**
 *  The <tt>seidgewick.FlowNetwork</tt> class represents a capacitated network
...
public class FlowNetwork {
    ...
    public FlowNetwork(int V) {
        if (V < 0) throw new IllegalArgumentException("Number of vertices in a seidgewick.Graph must be nonnegative");
        this.V = V;
        this.E = 0;
    ...
    /**
     * Unit tests the <tt>seidgewick.FlowNetwork</tt> data type.
     */
