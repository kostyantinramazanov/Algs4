...
/*************************************************************************
 *  Compilation:  javac seidgewick.LongestCommonSubstring.java
 *  Execution:    java  seidgewick.LongestCommonSubstring file1.txt file2.txt
 *  Dependencies: seidgewick.SuffixArray.java StdOut.java In.java
 *  
 ...
 *  (and make sure seidgewick.SuffixArray.java doesn't choose the same one).
 * 
 *  % java seidgewick.LongestCommonSubstring tale.txt mobydick.txt
