package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.MaxPQ.java
 *  Execution:    java seidgewick.MaxPQ < input.txt
 *  
 *  Generic max priority queue implementation with a binary heap.
 *  Can be used with a comparator instead of the natural order,
 *  but the generic Key type must still be Comparable.
 *
 *  % java seidgewick.MaxPQ < tinyPQ.txt
 *  Q X P (6 left on pq)
 *
...
/**
 *  The <tt>seidgewick.MaxPQ</tt> class represents a priority queue of generic keys.
...
public class MaxPQ<Key> implements Iterable<Key> {
    ...
    **********************************************************************/
    ...
    /**
     * Unit tests the <tt>seidgewick.MaxPQ</tt> data type.
     */
