...
/*************************************************************************
 *  Compilation:  javac seidgewick.SparseVector.java
 *  Execution:    java seidgewick.SparseVector
 *  
...
public class SparseVector {
    ...
    public double dot(SparseVector that) {
        if (this.N != that.N) throw new IllegalArgumentException("seidgewick.Vector lengths disagree");
        double sum = 0.0;
