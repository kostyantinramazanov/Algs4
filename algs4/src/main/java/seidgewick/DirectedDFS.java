package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.DirectedDFS.java
 *  Execution:    java seidgewick.DirectedDFS V E
 *  Dependencies: seidgewick.Digraph.java seidgewick.Bag.java In.java StdOut.java
 ...
 *  Runs in O(E + V) time.
 *
 *  % java seidgewick.DirectedDFS tinyDG.txt 1
 *  1
 *
 *  % java seidgewick.DirectedDFS tinyDG.txt 2
 *  0 1 2 3 4 5
 *
 *  % java seidgewick.DirectedDFS tinyDG.txt 1 2 6
 *  0 1 2 3 4 5 6 8 9 10 11 12 
 *
 *************************************************************************/
/**
 *  The <tt>seidgewick.DirectedDFS</tt> class represents a data type for
...
public class DirectedDFS {
    ...
    /**
     * Unit tests the <tt>seidgewick.DirectedDFS</tt> data type.
     */
