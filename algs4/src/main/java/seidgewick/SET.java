package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.SET.java
 *  Execution:    java seidgewick.SET
 *  
...
/**
 *  The <tt>seidgewick.SET</tt> class represents an ordered set of comparable keys.
...
public class SET<Key extends Comparable<Key>> implements Iterable<Key> {
    ...
    /**
     * Unit tests the <tt>seidgewick.SET</tt> data type.
     */
