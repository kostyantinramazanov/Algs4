package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.BreadthFirstDirectedPaths.java
 *  Execution:    java seidgewick.BreadthFirstDirectedPaths V E
 *  Dependencies: seidgewick.Digraph.java seidgewick.Queue.java seidgewick.Stack.java
 *
 *  Run breadth first search on a digraph.
 *  Runs in O(E + V) time.
 *
 *  % java seidgewick.BreadthFirstDirectedPaths tinyDG.txt 3
 *  3 to 0 (2):  3->2->0
 *  3 to 1 (3):  3->2->0->1
 *  3 to 2 (1):  3->2
 *  3 to 3 (0):  3
...
public class BreadthFirstDirectedPaths {
    ...
    /**
     * Unit tests the <tt>seidgewick.BreadthFirstDirectedPaths</tt> data type.
     */
