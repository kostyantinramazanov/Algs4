package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.TarjanSCC.java
 *  Execution:    Java seidgewick.TarjanSCC V E
 *  Dependencies: seidgewick.Digraph.java seidgewick.Stack.java seidgewick.TransitiveClosure.java StdOut.java
 *
 ...
 *  Runs in O(E + V) time.
 *
 *  % java seidgewick.TarjanSCC tinyDG.txt
 *  5 components
 *  1 
 *  0 2 3 4 5 
 *  9 10 11 12 
...
/**
 *  The <tt>seidgewick.TarjanSCC</tt> class represents a data type for
...
public class TarjanSCC {
    ...
    /**
     * Unit tests the <tt>seidgewick.TarjanSCC</tt> data type.
     */
