package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.Cat.java
 *  Execution:    java seidgewick.Cat input0.txt input1.txt ... output.txt
 ...
 *  test.
 * 
 *  % java seidgewick.Cat in1.txt in2.txt out.txt
 *
 *  % more out.txt
 *  This is
 *  a tiny
...
/**
 *  The <tt>seidgewick.Cat</tt> class provides a client for concatenating the results
