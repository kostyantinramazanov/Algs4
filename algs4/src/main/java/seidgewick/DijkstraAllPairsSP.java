package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.DijkstraAllPairsSP.java
 *  Dependencies: seidgewick.EdgeWeightedDigraph.java Dijkstra.java
 *
...
/**
 *  The <tt>seidgewick.DijkstraAllPairsSP</tt> class represents a data type for solving the
