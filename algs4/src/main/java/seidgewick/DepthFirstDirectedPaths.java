package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.DepthFirstDirectedPaths.java
 *  Execution:    java seidgewick.DepthFirstDirectedPaths G s
 *  Dependencies: seidgewick.Digraph.java seidgewick.Stack.java
 *
...
/**
 *  The <tt>seidgewick.DepthFirstDirectedPaths</tt> class represents a data type for finding
...
public class DepthFirstDirectedPaths {
    ...
    /**
     * Unit tests the <tt>seidgewick.DepthFirstDirectedPaths</tt> data type.
     */
