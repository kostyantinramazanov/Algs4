package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.CPM.java
 *  Execution:    java seidgewick.CPM < input.txt
 *  Dependencies: seidgewick.EdgeWeightedDigraph.java AcyclicDigraphLP.java StdOut.java
 *  Data files:   http://algs4.cs.princeton.edu/44sp/jobsPC.txt
 *
 *  Critical path method.
 *
 *  % java seidgewick.CPM < jobsPC.txt
 *   job   start  finish
 *  --------------------
 *     0     0.0    41.0
 *     1    41.0    92.0
...
/**
 *  The <tt>seidgewick.CPM</tt> class provides a client that solves the
