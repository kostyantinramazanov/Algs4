package seidgewick; /****************************************************************************
 *  Compilation:  javac seidgewick.UF.java
 *  Execution:    java seidgewick.UF < input.txt
...
/**
 *  The <tt>seidgewick.UF</tt> class represents a <em>union-find data type</em>
