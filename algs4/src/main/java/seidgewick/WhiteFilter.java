...
/*************************************************************************
 *  Compilation:  javac seidgewick.WhiteFilter.java
 *  Execution:    java seidgewick.WhiteFilter whitelist.txt < input.txt
 ...
 *  was it the of 
 * 
 *  % java seidgewick.WhiteFilter list.txt < tinyTale.txt
