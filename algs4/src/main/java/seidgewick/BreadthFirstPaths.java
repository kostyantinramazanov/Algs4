package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.BreadthFirstPaths.java
 *  Execution:    java seidgewick.BreadthFirstPaths G s
 *  Dependencies: seidgewick.Graph.java seidgewick.Queue.java seidgewick.Stack.java StdOut.java
 *  Data files:   http://algs4.cs.princeton.edu/41undirected/tinyCG.txt
 *
 *  Run breadth first search on an undirected graph.
 *  Runs in O(E + V) time.
 *
 *  %  java seidgewick.Graph tinyCG.txt
 *  6 8
 *  0: 2 1 5 
 *  1: 0 2 
 *  2: 0 1 3 4 
 ...
 *  5: 3 0 
 *
 *  %  java seidgewick.BreadthFirstPaths tinyCG.txt 0
 *  0 to 0 (0):  0
 *  0 to 1 (1):  0-1
 *  0 to 2 (1):  0-2
 *  0 to 3 (2):  0-2-3
 ...
 *  0 to 5 (1):  0-5
 *
 *  %  java seidgewick.BreadthFirstPaths largeG.txt 0
 *  0 to 0 (0):  0
...
/**
 *  The <tt>seidgewick.BreadthFirstPaths</tt> class represents a data type for finding
...
public class BreadthFirstPaths {
    ...
    /**
     * Unit tests the <tt>seidgewick.BreadthFirstPaths</tt> data type.
     */
