package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.Interval2D.java
 *  Execution:    java seidgewick.Interval2D
 *  
...
/**
 *  The <tt>seidgewick.Interval2D</tt> class represents a closed two-dimensional interval,
 ...
 *  The class <code>seidgewick.Interval2D</code> includes methods for checking whether
...
public class Interval2D {
    ...
    /**
     * Unit tests the <tt>seidgewick.Interval2D</tt> data type.
     */
