package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.BoruvkaMST.java
 *  Execution:    java seidgewick.BoruvkaMST filename.txt
 *  Dependencies: seidgewick.EdgeWeightedGraph.java seidgewick.Edge.java seidgewick.Bag.java
 ...
 *
 *  % java seidgewick.BoruvkaMST tinyEWG.txt
 *  0-2 0.26000
 *  6-2 0.40000
 *  5-7 0.28000
 *  4-5 0.35000
...
/**
 *  The <tt>seidgewick.BoruvkaMST</tt> class represents a data type for computing a
...
public class BoruvkaMST {
    ...
    /**
     * Unit tests the <tt>seidgewick.BoruvkaMST</tt> data type.
     */
