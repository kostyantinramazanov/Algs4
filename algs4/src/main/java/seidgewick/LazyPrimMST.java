package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.LazyPrimMST.java
 *  Execution:    java seidgewick.LazyPrimMST filename.txt
 *  Dependencies: seidgewick.EdgeWeightedGraph.java seidgewick.Edge.java seidgewick.Queue.java
 *                seidgewick.MinPQ.java seidgewick.UF.java In.java StdOut.java
 ...
 *  algorithm.
 *
 *  %  java seidgewick.LazyPrimMST tinyEWG.txt
 *  0-7 0.16000
 *  1-7 0.19000
 *  0-2 0.26000
 *  2-3 0.17000
 ...
 *  1.81000
 *
 *  % java seidgewick.LazyPrimMST mediumEWG.txt
 *  0-225   0.02383
 *  49-225  0.03314
 *  44-49   0.02107
 *  44-204  0.01774
 ...
 *  10.46351
 *
 *  % java seidgewick.LazyPrimMST largeEWG.txt
 *  ...
 *  647.66307
 *
 *************************************************************************/
...
/**
 *  The <tt>seidgewick.LazyPrimMST</tt> class represents a data type for computing a
...
public class LazyPrimMST {
            ...
            for (Edge f : G.edges()) {
                ...
                if (!uf.connected(x, y)) {
                    if (f.weight() < e.weight()) {
                        System.err.println("seidgewick.Edge " + f + " violates cut optimality conditions");
                        return false;
                    }
                }
            }
    ...
    /**
     * Unit tests the <tt>seidgewick.LazyPrimMST</tt> data type.
     */
